    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            /*2dСоздайте строку на основе StringBuilder. Удалите определенные позиции и добавьте новые символы в начало
             и конец строки*/
            StringBuilder strb = new StringBuilder(" строка моя");
            strb.Remove(8, 3);            ///удалите опр. позиции
            strb.Insert(0, "Это");      ///добавить символы в начало
            strb.Append("новая");       ///и конец строки
            ...
            b.Разместите в одной из них блок checked, в котором определите переменную типа int с максимальным возможным 
            значением этого типа.Во второй функции определите блок unchecked с таким же содержимым.
            ...
            void func2()
            {
                unchecked
                {
                    ...
                    int uncheck = 2147483647;
                    Console.WriteLine(uncheck + 1);
                }
            }
